...
See the section "Full command-line options" for more details. 

In order to rerun MetaPhlAn_Strainer quickly with new parameters, you can reuse the ".markers" files from previous step as follows:
